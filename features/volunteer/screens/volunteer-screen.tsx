...
import {
  type VolunteerTabKey,
  VolunteerTabs,
} from "@/components/volunteer/volunteer-tabs";
import {
...
export default function VolunteerScreen() {
  ...
  const [activeTab, setActiveTab] = useState<VolunteerTabKey>("calendar");
  ...
  const visibleEvents =
    activeTab === "calendar" ? eventsForSelectedDate : visibleLocalEvents;
  const emptyStateMessage =
    activeTab === "calendar"
      ? "No volunteer events scheduled for this date."
      : "No volunteer listings available.";
